  ...
  return (
    <footer className="footer">
      <div className="footer-inner">
        <p className="footer-copy">© {year} Aolin Xu</p>
        <a href="mailto:aolinxu@gmail.com" className="footer-email">
          aolinxu@gmail.com
        </a>
        <div className="footer-socials">
          <a href="https://github.com/aolinxuu" target="_blank" rel="noopener noreferrer" className="footer-icon" aria-label="GitHub">
            <img src="GitHub.svg" alt="" />
          </a>
          <a href="https://www.linkedin.com/in/aolin-xu-b01798194/" target="_blank" rel="noopener noreferrer" className="footer-icon" aria-label="LinkedIn">
            <img src="Linkedin.svg" alt="" />
          </a>
          <a href="https://www.tiktok.com/@aolinxu" target="_blank" rel="noopener noreferrer" className="footer-icon" aria-label="TikTok">
            <img src="TikTok.svg" alt="" />
          </a>
          <a href="https://www.instagram.com/aolin_xu/?hl=en" target="_blank" rel="noopener noreferrer" className="footer-icon" aria-label="Instagram">
